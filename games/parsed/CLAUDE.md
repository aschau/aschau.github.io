...
## Files
- `index.html`, `style.css`, `game.js` (core engine), `interpreter.module.js` (testable pure logic — keep in sync with game.js), `puzzles.js` (inline data + daily selection), `share.js`, `generate.py`, `verify_puzzles.py`, `debug.html` (gitignored)
