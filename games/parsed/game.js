...
(function () {
    ...
    var SCENE_CONFIGS = {
        '6b16bbe0': { emoji: '\u26CF\uFE0F', driverVar: 'mined', min: 0, max: 30, label: 'Mined' },
        '13742abb': { emoji: '\uD83D\uDC1F', driverVar: 'seasons', min: 0, max: 6, label: 'Seasons' },
        '2285009f': { emoji: '\uD83C\uDFA8', driverVar: 'art', min: 30, max: 30, label: 'Art' },
        '8b795b27': { emoji: '\uD83D\uDD2B', driverVar: 'kills', min: 0, max: 6, label: 'Kills' },
        '2edd3cd4': { emoji: '\uD83E\uDDA0', driverVar: 'virus', min: 1, max: 256, label: 'Virus' },
        'efdd0f88': { emoji: '\uD83C\uDF27\uFE0F', driverVar: 'weather', min: 12, max: 12, label: 'Weather' },
        '5a167cf6': { emoji: '\uD83C\uDFA8', driverVar: 'colored', min: 10, max: 10, label: 'Colored' },
        '30a53333': { emoji: '\uD83C\uDFED', driverVar: 'output', min: 0, max: 48, label: 'Output' },
        '5dc31d36': { emoji: '\uD83E\uDE91', driverVar: 'seating', min: 32, max: 32, label: 'Seating' },
        '677ab47e': { emoji: '\uD83C\uDF27\uFE0F', driverVar: 'crop', min: 0, max: 60, label: 'Crop' },
        '97c42368': { emoji: '\uD83D\uDD0B', driverVar: 'hours', min: 0, max: 8, label: 'Hours' },
        'f16e140d': { emoji: '\u2694\uFE0F', driverVar: 'hit', min: 7, max: 7, label: 'Hit' },
        '5b6a6850': { emoji: '\u26FD', driverVar: 'range', min: 0, max: 90, label: 'Range' },
        'be206f98': { emoji: '\uD83E\uDDE3', driverVar: 'scarves', min: 0, max: 7, label: 'Scarves' },
        '094c8ffb': { emoji: '\uD83C\uDFF4\u200D\u2620\uFE0F', driverVar: 'crew', min: 90, max: 90, label: 'Crew' },
        '7b1bb33c': { emoji: '\u26CF\uFE0F', driverVar: 'gold', min: 0, max: 36, label: 'Gold' },
        'fd333878': { emoji: '\uD83C\uDF54', driverVar: 'eaten', min: 0, max: 27, label: 'Eaten' },
        'b263a254': { emoji: '\uD83D\uDC7E', driverVar: 'outcome', min: 0, max: 20, label: 'Outcome' },
        '8908a096': { emoji: '\uD83C\uDF93', driverVar: 'gpa', min: 0, max: 25, label: 'Gpa' },
        '38299576': { emoji: '\u26A1', driverVar: 'action', min: 0, max: 80, label: 'Action' },
        'e25e49d5': { emoji: '\uD83E\uDD5E', driverVar: 'batter', min: 30, max: 30, label: 'Batter' },
        '648311ed': { emoji: '\uD83D\uDD0C', driverVar: 'circuits', min: 0, max: 9, label: 'Circuits' },
        'afb93d55': { emoji: '\uD83D\uDCA7', driverVar: 'harvests', min: 0, max: 5, label: 'Harvests' },
        '2f7faf96': { emoji: '\uD83C\uDF3B', driverVar: 'planted', min: 0, max: 50, label: 'Planted' },
        'fdcee658': { emoji: '\uD83E\uDE9A', driverVar: 'shelves', min: 9, max: 9, label: 'Shelves' },
        '9dd9ccd9': { emoji: '\uD83D\uDCAA', driverVar: 'result', min: 0, max: 20, label: 'Result' },
        '1d387d14': { emoji: '\uD83D\uDCAA', driverVar: 'muscle', min: 0, max: 40, label: 'Muscle' },
        '15e09003': { emoji: '\uD83C\uDF5E', driverVar: 'loaves', min: 0, max: 5, label: 'Loaves' },
        '7c363a1e': { emoji: '\uD83C\uDFC8', driverVar: 'total', min: 35, max: 35, label: 'Total' },
        '1ec60aab': { emoji: '\u26C8\uFE0F', driverVar: 'storm', min: 0, max: 10, label: 'Storm' },
        '6dc3f31c': { emoji: '\uD83D\uDCB0', driverVar: 'savings', min: 0, max: 30, label: 'Savings' },
        'ea88ec70': { emoji: '\uD83D\uDEEB', driverVar: 'height', min: 180, max: 180, label: 'Height' },
        '6c3a7cd2': { emoji: '\uD83C\uDF44', driverVar: 'mold', min: 3, max: 81, label: 'Mold' },
        'b493c717': { emoji: '\u2B50', driverVar: 'level', min: 0, max: 60, label: 'Level' },
        '332ce4dd': { emoji: '\uD83D\uDD0B', driverVar: 'charged', min: 0, max: 36, label: 'Charged' },
        '61a5b268': { emoji: '\uD83D\uDCB5', driverVar: 'bill', min: 20, max: 20, label: 'Bill' },
        'f23a3731': { emoji: '\uD83E\uDDA0', driverVar: 'bacteria', min: 2, max: 64, label: 'Bacteria' },
        '38df1572': { emoji: '\uD83C\uDFD7\uFE0F', driverVar: 'towers', min: 0, max: 24, label: 'Towers' },
        '91b3e052': { emoji: '\u2764\uFE0F', driverVar: 'health', min: 65, max: 65, label: 'Health' },
        '6ba0dd70': { emoji: '\uD83C\uDF55', driverVar: 'slices', min: 4, max: 4, label: 'Slices' },
        '72e6ca6c': { emoji: '\uD83E\uDEA1', driverVar: 'seams', min: 0, max: 7, label: 'Seams' },
        'fa6967ca': { emoji: '\uD83D\uDC38', driverVar: 'jumps', min: 0, max: 5, label: 'Jumps' },
        '72469923': { emoji: '\uD83C\uDF27\uFE0F', driverVar: 'collected', min: 0, max: 60, label: 'Collected' },
        'f1b82017': { emoji: '\uD83C\uDF3D', driverVar: 'harvest', min: 0, max: 28, label: 'Harvest' },
        '0b2bf48c': { emoji: '\uD83E\uDDDD', driverVar: 'party', min: 11, max: 11, label: 'Party' },
        'fd78e80d': { emoji: '\uD83C\uDFF0', driverVar: 'castles', min: 0, max: 5, label: 'Castles' },
        '2f3e6cdb': { emoji: '\uD83D\uDCB5', driverVar: 'pay', min: 12, max: 12, label: 'Pay' },
        '2bc68e51': { emoji: '\uD83D\uDCB0', driverVar: 'savings', min: 180, max: 180, label: 'Savings' },
        'e9601fd8': { emoji: '\uD83D\uDC1D', driverVar: 'honey', min: 0, max: 19, label: 'Honey' },
        '2b304229': { emoji: '\uD83D\uDEF0\uFE0F', driverVar: 'burns', min: 0, max: 4, label: 'Burns' },
        '969d30ae': { emoji: '\uD83D\uDCBB', driverVar: 'speed', min: 34, max: 34, label: 'Speed' },
        'dee848df': { emoji: '\uD83E\uDE84', driverVar: 'reserve', min: 45, max: 45, label: 'Reserve' },
        'd1fa4717': { emoji: '\uD83D\uDCA5', driverVar: 'pressure', min: 0, max: 63, label: 'Pressure' },
        '00695251': { emoji: '\uD83C\uDF82', driverVar: 'cake', min: 25, max: 25, label: 'Cake' },
        '14d2db46': { emoji: '\uD83D\uDED2', driverVar: 'sales', min: 0, max: 5, label: 'Sales' },
        '001dc6ba': { emoji: '\uD83D\uDCAA', driverVar: 'reps', min: 0, max: 40, label: 'Reps' },
        'a431e82d': { emoji: '\uD83D\uDEF8', driverVar: 'dist', min: 20, max: 20, label: 'Dist' },
        'edfa7426': { emoji: '\uD83C\uDF55', driverVar: 'toppings', min: 15, max: 15, label: 'Toppings' },
        'b76a901b': { emoji: '\uD83D\uDE80', driverVar: 'missions', min: 11, max: 11, label: 'Missions' },
        '64313db8': { emoji: '\uD83C\uDFCB\uFE0F', driverVar: 'weeks', min: 0, max: 5, label: 'Weeks' },
        'd6f23b22': { emoji: '\uD83C\uDF0A', driverVar: 'ripple', min: 1, max: 128, label: 'Ripple' },
        '2754b7fd': { emoji: '\uD83D\uDC1B', driverVar: 'quality', min: 10, max: 10, label: 'Quality' },
        'db8fdff2': { emoji: '\uD83C\uDFE6', driverVar: 'payments', min: 0, max: 5, label: 'Payments' },
        'e92de4f1': { emoji: '\uD83D\uDD8C\uFE0F', driverVar: 'paint', min: 0, max: 34, label: 'Paint' },
        '4ae2abd9': { emoji: '\uD83D\uDCDD', driverVar: 'pages', min: 0, max: 48, label: 'Pages' },
        '0b6a5f67': { emoji: '\uD83C\uDFF9', driverVar: 'volleys', min: 0, max: 5, label: 'Volleys' },
        '918f1342': { emoji: '\uD83D\uDD25', driverVar: 'fire', min: 2, max: 128, label: 'Fire' },
        '7d500b85': { emoji: '\uD83D\uDDA8\uFE0F', driverVar: 'prints', min: 0, max: 4, label: 'Prints' },
        '10efcc40': { emoji: '\uD83D\uDCE6', driverVar: 'net', min: 30, max: 30, label: 'Net' },
        '22a1235e': { emoji: '\uD83C\uDF3E', driverVar: 'flour', min: 36, max: 36, label: 'Flour' },
        'f2162787': { emoji: '\uD83D\uDEE1\uFE0F', driverVar: 'defense', min: 32, max: 32, label: 'Defense' },
        'bfb6cafc': { emoji: '\uD83D\uDCA8', driverVar: 'action', min: 0, max: 55, label: 'Action' },
        'f6732a36': { emoji: '\uD83D\uDC3A', driverVar: 'predators', min: 8, max: 8, label: 'Predators' },
        '27848ed3': { emoji: '\uD83D\uDC80', driverVar: 'plague', min: 5, max: 40, label: 'Plague' },
        '31aa35c7': { emoji: '\uD83C\uDFCE\uFE0F', driverVar: 'distance', min: 0, max: 30, label: 'Distance' },
        'bda71467': { emoji: '\uD83D\uDC3A', driverVar: 'herd', min: 0, max: 25, label: 'Herd' },
        '7b590e97': { emoji: '\u26FD', driverVar: 'trips', min: 0, max: 6, label: 'Trips' },
        '0c5de7b0': { emoji: '\u2694\uFE0F', driverVar: 'rooms', min: 0, max: 8, label: 'Rooms' },
        '35fcdf18': { emoji: '\uD83E\uDD3F', driverVar: 'dives', min: 0, max: 6, label: 'Dives' },
        '0abe0386': { emoji: '\u2622\uFE0F', driverVar: 'reactor', min: 0, max: 60, label: 'Reactor' },
        'c74463c8': { emoji: '\uD83E\uDE62', driverVar: 'knots', min: 0, max: 7, label: 'Knots' },
        'f574d4f2': { emoji: '\u26C4', driverVar: 'snowball', min: 1, max: 81, label: 'Snowball' },
        'e44f7deb': { emoji: '\uD83C\uDF31', driverVar: 'harvest', min: 36, max: 36, label: 'Harvest' },
        'f0718abd': { emoji: '\uD83C\uDFD8\uFE0F', driverVar: 'population', min: 10, max: 28, label: 'Population' },
        '8bfb2b77': { emoji: '\uD83D\uDC8E', driverVar: 'crystal', min: 1, max: 125, label: 'Crystal' },
        '35d1e050': { emoji: '\uD83E\uDD67', driverVar: 'pies', min: 0, max: 7, label: 'Pies' },
        '5aba8bd9': { emoji: '\uD83C\uDFF4\u200D\u2620\uFE0F', driverVar: 'days', min: 0, max: 7, label: 'Days' },
        'f762b380': { emoji: '\uD83D\uDCB0', driverVar: 'earned', min: 0, max: 70, label: 'Earned' },
        '1227482a': { emoji: '\uD83D\uDE80', driverVar: 'altitude', min: 0, max: 100, label: 'Altitude' },
        '680c5341': { emoji: '\uD83D\uDCF1', driverVar: 'calls', min: 0, max: 6, label: 'Calls' },
        'd2a5f22d': { emoji: '\uD83C\uDFA8', driverVar: 'layers', min: 0, max: 24, label: 'Layers' },
        '47705d50': { emoji: '\u26BD', driverVar: 'points', min: 11, max: 11, label: 'Points' },
        '1e43120c': { emoji: '\u26F5', driverVar: 'speed', min: 0, max: 22, label: 'Speed' },
        '155132d5': { emoji: '\uD83D\uDEEB', driverVar: 'flight', min: 42, max: 42, label: 'Flight' },
        '49ca2f94': { emoji: '\uD83C\uDF0A', driverVar: 'dive', min: 0, max: 40, label: 'Dive' },
        '86738f69': { emoji: '\uD83C\uDF31', driverVar: 'crop', min: 0, max: 5, label: 'Crop' },
        'fc918a7f': { emoji: '\uD83E\uDE9A', driverVar: 'build', min: 0, max: 5, label: 'Build' },
        '82856fbe': { emoji: '\uD83D\uDD25', driverVar: 'heat', min: 0, max: 40, label: 'Heat' },
        'de2e9d6a': { emoji: '\uD83C\uDF7A', driverVar: 'brew', min: 0, max: 30, label: 'Brew' },
        'f82620d5': { emoji: '\uD83D\uDCDA', driverVar: 'reading', min: 57, max: 57, label: 'Reading' },
        'ea73f574': { emoji: '\uD83C\uDFCA', driverVar: 'miles', min: 0, max: 20, label: 'Miles' },
        '31f834cb': { emoji: '\uD83D\uDCE6', driverVar: 'warehouse', min: 27, max: 27, label: 'Warehouse' },
        '75b2b0b0': { emoji: '\uD83D\uDD25', driverVar: 'cooked', min: 0, max: 5, label: 'Cooked' },
        '343cc243': { emoji: '\uD83D\uDCB0', driverVar: 'loot', min: 0, max: 75, label: 'Loot' },
        'e31b9229': { emoji: '\u2615', driverVar: 'energy', min: 0, max: 16, label: 'Energy' },
        '2ebc1ddb': { emoji: '\uD83C\uDFF0', driverVar: 'force', min: 0, max: 32, label: 'Force' },
        'c02e973e': { emoji: '\uD83D\uDD8C\uFE0F', driverVar: 'rooms', min: 0, max: 3, label: 'Rooms' },
        '8b1b5a52': { emoji: '\u23F0', driverVar: 'alerts', min: 0, max: 7, label: 'Alerts' },
        'ef80e36f': { emoji: '\uD83D\uDCB0', driverVar: 'buy', min: 0, max: 20, label: 'Buy' },
        '6ed0d99c': { emoji: '\uD83C\uDF4E', driverVar: 'basket', min: 0, max: 23, label: 'Basket' },
        'e48b0f7d': { emoji: '\u2708\uFE0F', driverVar: 'seats', min: 70, max: 70, label: 'Seats' },
        'ed366344': { emoji: '\uD83D\uDC8E', driverVar: 'result', min: 0, max: 45, label: 'Result' },
        '136ba642': { emoji: '\uD83C\uDFE0', driverVar: 'spent', min: 0, max: 360, label: 'Spent' },
        '6804a0d4': { emoji: '\uD83C\uDF31', driverVar: 'size', min: 0, max: 25, label: 'Size' },
        'c62e5ad9': { emoji: '\uD83D\uDCD0', driverVar: 'area', min: 63, max: 63, label: 'Area' },
        '955cd209': { emoji: '\u2696\uFE0F', driverVar: 'boost', min: 0, max: 55, label: 'Boost' },
        'b96b1dbe': { emoji: '\uD83D\uDD2C', driverVar: 'tests', min: 0, max: 21, label: 'Tests' },
        '57b2e72f': { emoji: '\uD83E\uDD81', driverVar: 'bigCats', min: 15, max: 15, label: 'Bigcats' },
        'a5c7b7c5': { emoji: '\u2744\uFE0F', driverVar: 'days', min: 0, max: 10, label: 'Days' },
        '0a974eaa': { emoji: '\uD83E\uDDCA', driverVar: 'minutes', min: 0, max: 5, label: 'Minutes' },
        'f8292273': { emoji: '\u2764\uFE0F', driverVar: 'remain', min: 85, max: 85, label: 'Remain' },
        '1e8ef0fe': { emoji: '\uD83D\uDCB5', driverVar: 'savings', min: 0, max: 150, label: 'Savings' },
        'd2e136a1': { emoji: '\uD83C\uDFB8', driverVar: 'instruments', min: 7, max: 7, label: 'Instruments' },
        '390cd8f7': { emoji: '\uD83D\uDCDD', driverVar: 'final', min: 27, max: 27, label: 'Final' },
        '524f81d8': { emoji: '\uD83C\uDFAC', driverVar: 'scenes', min: 0, max: 6, label: 'Scenes' },
        '2da82cd3': { emoji: '\uD83D\uDCB8', driverVar: 'monthly', min: 25, max: 25, label: 'Monthly' },
        'f0ff2c24': { emoji: '\u2694\uFE0F', driverVar: 'battles', min: 0, max: 6, label: 'Battles' },
        'a0fb2f8c': { emoji: '\uD83E\uDDEA', driverVar: 'vials', min: 0, max: 40, label: 'Vials' },
        '80ca2bb5': { emoji: '\uD83D\uDD28', driverVar: 'weapons', min: 72, max: 72, label: 'Weapons' },
        '1ea186e9': { emoji: '\uD83C\uDF93', driverVar: 'passed', min: 0, max: 20, label: 'Passed' },
        '4f71b53b': { emoji: '\u2600\uFE0F', driverVar: 'watts', min: 0, max: 48, label: 'Watts' },
        '0031181f': { emoji: '\uD83C\uDFB5', driverVar: 'melody', min: 0, max: 56, label: 'Melody' },
        '95a73772': { emoji: '\uD83C\uDFE2', driverVar: 'total', min: 48, max: 48, label: 'Total' },
        'ddd5d912': { emoji: '\uD83C\uDFAF', driverVar: 'reward', min: 0, max: 24, label: 'Reward' },
        'cdff7daa': { emoji: '\uD83D\uDD25', driverVar: 'minutes', min: 0, max: 9, label: 'Minutes' },
        '8dbf5060': { emoji: '\uD83C\uDF3E', driverVar: 'yield', min: 15, max: 15, label: 'Yield' },
        'a0768501': { emoji: '\uD83C\uDF0D', driverVar: 'fallen', min: 0, max: 24, label: 'Fallen' },
        '1b7e7435': { emoji: '\uD83E\uDDE9', driverVar: 'moves', min: 0, max: 5, label: 'Moves' },
        'a65cf989': { emoji: '\uD83C\uDF86', driverVar: 'fireworks', min: 0, max: 30, label: 'Fireworks' },
        '14bebae8': { emoji: '\uD83E\uDD8B', driverVar: 'total', min: 22, max: 22, label: 'Total' },
        'cc6b605a': { emoji: '\uD83E\uDDD9', driverVar: 'wisdom', min: 0, max: 42, label: 'Wisdom' },
        '8f15a794': { emoji: '\uD83D\uDEE1\uFE0F', driverVar: 'charge', min: 2, max: 12, label: 'Charge' },
        '4d042728': { emoji: '\uD83C\uDF6C', driverVar: 'each', min: 4, max: 4, label: 'Each' },
        '7720e676': { emoji: '\u2699\uFE0F', driverVar: 'alloy', min: 0, max: 30, label: 'Alloy' },
        '50d73e80': { emoji: '\uD83D\uDDA8\uFE0F', driverVar: 'pages', min: 0, max: 6, label: 'Pages' },
        'dfd17582': { emoji: '\uD83D\uDCA5', driverVar: 'dmg', min: 24, max: 24, label: 'Dmg' },
        '0076eb1b': { emoji: '\uD83C\uDF6A', driverVar: 'treats', min: 43, max: 43, label: 'Treats' },
        'fb0e4f10': { emoji: '\uD83D\uDCE3', driverVar: 'morale', min: 0, max: 21, label: 'Morale' },
        'a1587032': { emoji: '\uD83E\uDDF1', driverVar: 'wall', min: 0, max: 48, label: 'Wall' },
        '6d8f63bd': { emoji: '\uD83C\uDF3F', driverVar: 'rows', min: 0, max: 4, label: 'Rows' },
        '56d77e74': { emoji: '\uD83C\uDFA8', driverVar: 'pixels', min: 25, max: 25, label: 'Pixels' },
        '04c2720f': { emoji: '\uD83D\uDC31', driverVar: 'pets', min: 12, max: 12, label: 'Pets' },
        '1426d175': { emoji: '\uD83E\uDE84', driverVar: 'power', min: 1, max: 243, label: 'Power' },
        'f9c7f6d3': { emoji: '\uD83D\uDC8A', driverVar: 'health', min: 0, max: 12, label: 'Health' },
        '82d8bdbf': { emoji: '\uD83D\uDC7E', driverVar: 'xpEach', min: 25, max: 25, label: 'Xpeach' },
        '4cf74352': { emoji: '\uD83D\uDE80', driverVar: 'thrust', min: 0, max: 50, label: 'Thrust' },
        '37f3137c': { emoji: '\uD83C\uDFF0', driverVar: 'volleys', min: 0, max: 10, label: 'Volleys' },
        'd7ee1255': { emoji: '\uD83C\uDFF0', driverVar: 'army', min: 17, max: 17, label: 'Army' },
        '24a096e1': { emoji: '\uD83C\uDFB6', driverVar: 'rhythm', min: 21, max: 21, label: 'Rhythm' },
        '8859fa0d': { emoji: '\uD83D\uDCE1', driverVar: 'signal', min: 0, max: 35, label: 'Signal' },
        '257c2016': { emoji: '\uD83D\uDC8E', driverVar: 'treasure', min: 25, max: 25, label: 'Treasure' },
        'a214f984': { emoji: '\uD83C\uDF21\uFE0F', driverVar: 'fahrenheit', min: 68, max: 68, label: 'Fahrenheit' },
        '70e68134': { emoji: '\uD83D\uDD0B', driverVar: 'charge', min: 63, max: 63, label: 'Charge' },
        '7c2d170c': { emoji: '\u2B50', driverVar: 'status', min: 0, max: 50, label: 'Status' },
        '68146a8e': { emoji: '\uD83C\uDF27\uFE0F', driverVar: 'crop', min: 0, max: 20, label: 'Crop' },
        '528b4f72': { emoji: '\uD83D\uDDB1\uFE0F', driverVar: 'clicks', min: 0, max: 28, label: 'Clicks' },
        '7dcab49b': { emoji: '\uD83C\uDF3B', driverVar: 'flowers', min: 0, max: 18, label: 'Flowers' },
        'b5b04614': { emoji: '\u2728', driverVar: 'gold', min: 0, max: 27, label: 'Gold' },
        '12f4ca20': { emoji: '\uD83D\uDCAF', driverVar: 'grade', min: 0, max: 90, label: 'Grade' },
        '10363378': { emoji: '\u2600\uFE0F', driverVar: 'stored', min: 0, max: 60, label: 'Stored' },
        '7f2ac7c3': { emoji: '\uD83D\uDD25', driverVar: 'net', min: 65, max: 65, label: 'Net' },
        'a14d112a': { emoji: '\uD83C\uDFC0', driverVar: 'height', min: 0, max: 30, label: 'Height' },
        '86a42cd1': { emoji: '\uD83E\uDDE0', driverVar: 'network', min: 48, max: 48, label: 'Network' },
        '98d4ad93': { emoji: '\u2B50', driverVar: 'xp', min: 0, max: 45, label: 'Xp' },
        'f50820dc': { emoji: '\uD83C\uDFAE', driverVar: 'sprites', min: 0, max: 5, label: 'Sprites' },
        'cc7c13d2': { emoji: '\uD83E\uDD3F', driverVar: 'dives', min: 0, max: 6, label: 'Dives' },
        '1b00d6d6': { emoji: '\uD83C\uDF5E', driverVar: 'yeast', min: 5, max: 40, label: 'Yeast' },
        '538856da': { emoji: '\uD83D\uDE97', driverVar: 'distance', min: 60, max: 60, label: 'Distance' },
        'd0a16cfc': { emoji: '\uD83C\uDF3E', driverVar: 'harvest', min: 0, max: 38, label: 'Harvest' },
        '8673635b': { emoji: '\uD83D\uDD0C', driverVar: 'output', min: 0, max: 60, label: 'Output' },
        '52b63357': { emoji: '\uD83C\uDFB5', driverVar: 'measures', min: 0, max: 32, label: 'Measures' },
        'c54cee80': { emoji: '\uD83C\uDFB6', driverVar: 'beats', min: 0, max: 210, label: 'Beats' },
        '8ff3e8cf': { emoji: '\uD83D\uDCBE', driverVar: 'free', min: 384, max: 384, label: 'Free' },
        '4c88d4df': { emoji: '\uD83D\uDC0D', driverVar: 'bites', min: 0, max: 6, label: 'Bites' },
        'c1ae95a3': { emoji: '\uD83D\uDCE7', driverVar: 'messages', min: 57, max: 57, label: 'Messages' },
        '6b3427ac': { emoji: '\uD83D\uDCE1', driverVar: 'clarity', min: 0, max: 16, label: 'Clarity' },
        '555e0f7a': { emoji: '\u269B\uFE0F', driverVar: 'particles', min: 14, max: 14, label: 'Particles' },
        '7b8066ce': { emoji: '\uD83E\uDE99', driverVar: 'coins', min: 65, max: 65, label: 'Coins' },
        '3d08285b': { emoji: '\uD83C\uDF3F', driverVar: 'remedy', min: 0, max: 16, label: 'Remedy' },
        '29885829': { emoji: '\uD83C\uDFAF', driverVar: 'total', min: 0, max: 70, label: 'Total' },
        '55d9d436': { emoji: '\uD83C\uDF55', driverVar: 'meals', min: 8, max: 8, label: 'Meals' },
        'e3d4e76d': { emoji: '\u26FD', driverVar: 'mpg', min: 30, max: 30, label: 'Mpg' },
        'f4b07f83': { emoji: '\uD83C\uDFDF\uFE0F', driverVar: 'venue', min: 65, max: 65, label: 'Venue' },
        'd41643aa': { emoji: '\uD83C\uDF0D', driverVar: 'motion', min: 48, max: 48, label: 'Motion' },
        '075f712a': { emoji: '\uD83C\uDF21\uFE0F', driverVar: 'hours', min: 0, max: 5, label: 'Hours' },
        '6afc86bc': { emoji: '\uD83D\uDC8E', driverVar: 'jewels', min: 22, max: 22, label: 'Jewels' },
        '0c885e3b': { emoji: '\uD83D\uDE24', driverVar: 'days', min: 0, max: 5, label: 'Days' },
        '8e692185': { emoji: '\uD83C\uDF72', driverVar: 'broth', min: 35, max: 35, label: 'Broth' },
        '8b487f53': { emoji: '\uD83D\uDC8A', driverVar: 'vitamin', min: 0, max: 28, label: 'Vitamin' },
        'f3b1d630': { emoji: '\uD83D\uDCF1', driverVar: 'followers', min: 4, max: 108, label: 'Followers' },
        '134f7f41': { emoji: '\uD83D\uDCDA', driverVar: 'knowledge', min: 0, max: 25, label: 'Knowledge' },
        '923e6bf7': { emoji: '\uD83E\uDD4A', driverVar: 'rounds', min: 0, max: 4, label: 'Rounds' },
        '0b9ed751': { emoji: '\u26A1', driverVar: 'hits', min: 0, max: 5, label: 'Hits' },
        'ada7a0fd': { emoji: '\uD83D\uDED2', driverVar: 'cost', min: 60, max: 60, label: 'Cost' },
        '42e99fd9': { emoji: '\uD83D\uDD77\uFE0F', driverVar: 'total', min: 24, max: 24, label: 'Total' },
        '5b253187': { emoji: '\uD83D\uDC8A', driverVar: 'final', min: 85, max: 85, label: 'Final' },
        '7adc77ee': { emoji: '\uD83C\uDFAE', driverVar: 'score', min: 0, max: 18, label: 'Score' },
        'f9f52f2f': { emoji: '\uD83D\uDCC5', driverVar: 'weekly', min: 21, max: 21, label: 'Weekly' },
        '2859e1cb': { emoji: '\uD83D\uDEB6', driverVar: 'distance', min: 0, max: 35, label: 'Distance' },
        'd22d0607': { emoji: '\uD83D\uDE97', driverVar: 'total', min: 32, max: 32, label: 'Total' },
        'd2a66ac0': { emoji: '\uD83E\uDDF1', driverVar: 'rows', min: 0, max: 60, label: 'Rows' },
        '8c23b137': { emoji: '\uD83C\uDF96\uFE0F', driverVar: 'rank', min: 12, max: 12, label: 'Rank' },
        '17706480': { emoji: '\uD83C\uDF3E', driverVar: 'harvest', min: 0, max: 45, label: 'Harvest' },
        'b32fe104': { emoji: '\uD83D\uDCE6', driverVar: 'remaining', min: 35, max: 35, label: 'Remaining' },
        'ab27b3c3': { emoji: '\uD83E\uDD1D', driverVar: 'ally', min: 0, max: 30, label: 'Ally' },
        'f16547fc': { emoji: '\uD83D\uDCD6', driverVar: 'totalPages', min: 96, max: 96, label: 'Totalpages' },
        '8be8d3f3': { emoji: '\uD83D\uDE80', driverVar: 'burns', min: 0, max: 6, label: 'Burns' },
        '0d7f3559': { emoji: '\uD83E\uDDE0', driverVar: 'output', min: 0, max: 55, label: 'Output' },
        '3b846e3f': { emoji: '\uD83C\uDF70', driverVar: 'batter', min: 10, max: 10, label: 'Batter' },
        '2f64d9bc': { emoji: '\uD83D\uDCC8', driverVar: 'days', min: 0, max: 6, label: 'Days' },
        '8b92fc4f': { emoji: '\uD83E\uDE84', driverVar: 'casts', min: 0, max: 5, label: 'Casts' },
        '2de6ff34': { emoji: '\uD83C\uDF4E', driverVar: 'fruit', min: 20, max: 20, label: 'Fruit' },
        '9b1b2f40': { emoji: '\uD83E\uDDEA', driverVar: 'potency', min: 1, max: 47, label: 'Potency' },
        '0297b7b2': { emoji: '\uD83C\uDFB2', driverVar: 'score', min: 0, max: 20, label: 'Score' },
        '59ca64dd': { emoji: '\uD83C\uDF80', driverVar: 'bows', min: 0, max: 8, label: 'Bows' },
        '582d2099': { emoji: '\uD83E\uDDC2', driverVar: 'flavor', min: 14, max: 14, label: 'Flavor' },
        'ee7a8a9e': { emoji: '\u26A1', driverVar: 'voltage', min: 5, max: 14, label: 'Voltage' },
        '821b3d89': { emoji: '\uD83E\uDE62', driverVar: 'climbs', min: 0, max: 4, label: 'Climbs' },
        'f3bbd9bc': { emoji: '\uD83C\uDF66', driverVar: 'cones', min: 0, max: 12, label: 'Cones' },
        '96545a4f': { emoji: '\uD83D\uDD6F\uFE0F', driverVar: 'hours', min: 0, max: 6, label: 'Hours' },
        '50279331': { emoji: '\uD83D\uDDBC\uFE0F', driverVar: 'canvas', min: 32, max: 32, label: 'Canvas' },
        'b1cdcad9': { emoji: '\u26A1', driverVar: 'charge', min: 0, max: 21, label: 'Charge' },
        '9eb4a080': { emoji: '\uD83E\uDDDF', driverVar: 'zombies', min: 2, max: 64, label: 'Zombies' },
        'e1069273': { emoji: '\uD83D\uDD17', driverVar: 'chain', min: 2, max: 32, label: 'Chain' },
        '4d159063': { emoji: '\uD83C\uDFAE', driverVar: 'score', min: 0, max: 75, label: 'Score' },
        '6eab5fdd': { emoji: '\uD83C\uDFAB', driverVar: 'available', min: 52, max: 52, label: 'Available' },
        'bc4c7da5': { emoji: '\uD83D\uDC89', driverVar: 'absorbed', min: 0, max: 38, label: 'Absorbed' },
        '813e6f63': { emoji: '\uD83D\uDCA8', driverVar: 'total', min: 0, max: 30, label: 'Total' },
        '538ef028': { emoji: '\u2694\uFE0F', driverVar: 'weapons', min: 24, max: 24, label: 'Weapons' },
        'cfe40fa7': { emoji: '\uD83C\uDF3F', driverVar: 'algae', min: 3, max: 48, label: 'Algae' },
        '01e8be0b': { emoji: '\uD83C\uDFA3', driverVar: 'catch', min: 0, max: 8, label: 'Catch' },
        'ebb46176': { emoji: '\uD83C\uDFC3', driverVar: 'spacing', min: 7, max: 7, label: 'Spacing' },
        '4be488f4': { emoji: '\uD83D\uDC09', driverVar: 'days', min: 0, max: 3, label: 'Days' },
        '50e43aac': { emoji: '\uD83C\uDFC3', driverVar: 'collected', min: 0, max: 45, label: 'Collected' },
        'e1a39142': { emoji: '\uD83C\uDF3F', driverVar: 'potion', min: 0, max: 20, label: 'Potion' },
        '770a5adf': { emoji: '\uD83D\uDCA8', driverVar: 'reserve', min: 46, max: 46, label: 'Reserve' },
        '98466e44': { emoji: '\u26A1', driverVar: 'circuit', min: 0, max: 40, label: 'Circuit' },
        '97da0969': { emoji: '\uD83C\uDFB8', driverVar: 'total', min: 30, max: 30, label: 'Total' },
        'f88a16a6': { emoji: '\uD83C\uDFB8', driverVar: 'tune', min: 0, max: 6, label: 'Tune' },
        'b450f4fa': { emoji: '\uD83C\uDFF0', driverVar: 'waves', min: 0, max: 5, label: 'Waves' },
        '2f8e8374': { emoji: '\uD83C\uDF68', driverVar: 'sundae', min: 13, max: 13, label: 'Sundae' },
        '0f9d6cd3': { emoji: '\uD83C\uDFA3', driverVar: 'fish', min: 0, max: 12, label: 'Fish' },
        '63d91af2': { emoji: '\uD83E\uDEA8', driverVar: 'blocks', min: 0, max: 4, label: 'Blocks' },
        '121ef918': { emoji: '\uD83C\uDF3E', driverVar: 'bushels', min: 0, max: 56, label: 'Bushels' },
        'fc41aaf0': { emoji: '\uD83C\uDFD8\uFE0F', driverVar: 'residents', min: 145, max: 145, label: 'Residents' },
        '9e2f4256': { emoji: '\uD83C\uDFF4\u200D\u2620\uFE0F', driverVar: 'share', min: 20, max: 20, label: 'Share' },
        '2a8791f0': { emoji: '\uD83C\uDF2E', driverVar: 'order', min: 10, max: 10, label: 'Order' },
        '9bf0cfb4': { emoji: '\uD83D\uDE82', driverVar: 'freight', min: 70, max: 70, label: 'Freight' },
        '2e6ccbc7': { emoji: '\u2694\uFE0F', driverVar: 'damage', min: 0, max: 20, label: 'Damage' },
        '5c0f07de': { emoji: '\uD83E\uDE99', driverVar: 'loot', min: 22, max: 22, label: 'Loot' },
        '3dfcf881': { emoji: '\u2764\uFE0F', driverVar: 'turns', min: 0, max: 100, label: 'Turns' },
        'ca29d368': { emoji: '\uD83C\uDF3E', driverVar: 'crops', min: 0, max: 4, label: 'Crops' },
        '6e9dc503': { emoji: '\uD83C\uDFDB\uFE0F', driverVar: 'statues', min: 0, max: 4, label: 'Statues' },
        'dba02cf3': { emoji: '\uD83D\uDD0A', driverVar: 'echo', min: 2, max: 162, label: 'Echo' },
        '2ac9bece': { emoji: '\uD83C\uDFB5', driverVar: 'mix', min: 0, max: 28, label: 'Mix' },
        'f5bfabde': { emoji: '\uD83D\uDEE1\uFE0F', driverVar: 'block', min: 0, max: 15, label: 'Block' },
        'c27c5ed0': { emoji: '\uD83C\uDF73', driverVar: 'dishes', min: 0, max: 24, label: 'Dishes' },
        'a998e682': { emoji: '\uD83C\uDFB5', driverVar: 'seconds', min: 16, max: 16, label: 'Seconds' },
        'ab090f8a': { emoji: '\uD83C\uDFB5', driverVar: 'sound', min: 20, max: 20, label: 'Sound' },
        '4b143562': { emoji: '\uD83C\uDFE2', driverVar: 'steps', min: 0, max: 6, label: 'Steps' },
        'd58914fd': { emoji: '\uD83D\uDCDA', driverVar: 'lessons', min: 0, max: 5, label: 'Lessons' },
        'a9ec38af': { emoji: '\uD83C\uDFC3', driverVar: 'distance', min: 0, max: 60, label: 'Distance' },
        '41bc83bd': { emoji: '\uD83C\uDF92', driverVar: 'total', min: 16, max: 16, label: 'Total' },
        '4da93734': { emoji: '\uD83C\uDF6A', driverVar: 'cookies', min: 0, max: 36, label: 'Cookies' },
        '36e5597c': { emoji: '\uD83C\uDF54', driverVar: 'eat', min: 0, max: 20, label: 'Eat' },
        '79c6bb5d': { emoji: '\u231B', driverVar: 'years', min: 55, max: 55, label: 'Years' },
        '821c54ff': { emoji: '\uD83D\uDCAA', driverVar: 'power', min: 0, max: 36, label: 'Power' },
        'dd4d7fa1': { emoji: '\uD83E\uDED9', driverVar: 'pots', min: 0, max: 5, label: 'Pots' },
        'e3c716ff': { emoji: '\uD83C\uDF3A', driverVar: 'bouquets', min: 0, max: 30, label: 'Bouquets' },
        '72bd702e': { emoji: '\uD83C\uDFED', driverVar: 'total', min: 0, max: 27, label: 'Total' },
        'a3bdcd04': { emoji: '\uD83E\uDE84', driverVar: 'cast', min: 0, max: 20, label: 'Cast' },
        'd1501c80': { emoji: '\u26FD', driverVar: 'tank', min: 125, max: 125, label: 'Tank' },
        '4948791a': { emoji: '\u26BE', driverVar: 'innings', min: 0, max: 27, label: 'Innings' },
        'ae205a81': { emoji: '\uD83E\uDE84', driverVar: 'pool', min: 75, max: 75, label: 'Pool' },
        '3eb0828a': { emoji: '\uD83C\uDFA8', driverVar: 'shade', min: 0, max: 10, label: 'Shade' },
        'b3a680c9': { emoji: '\uD83E\uDED9', driverVar: 'firings', min: 0, max: 5, label: 'Firings' },
        '88235139': { emoji: '\u2744\uFE0F', driverVar: 'depth', min: 0, max: 20, label: 'Depth' },
        '37bbaefb': { emoji: '\uD83D\uDC7B', driverVar: 'rooms', min: 0, max: 5, label: 'Rooms' },
        'd26f72d4': { emoji: '\uD83D\uDEA2', driverVar: 'trips', min: 0, max: 10, label: 'Trips' },
        '0b8a9c52': { emoji: '\uD83D\uDCB5', driverVar: 'balance', min: 100, max: 145, label: 'Balance' },
        '08941f59': { emoji: '\uD83C\uDFE0', driverVar: 'cabin', min: 30, max: 30, label: 'Cabin' },
        '9c148695': { emoji: '\uD83D\uDCA8', driverVar: 'air', min: 58, max: 58, label: 'Air' },
        '33f5f153': { emoji: '\uD83D\uDE80', driverVar: 'thrust', min: 0, max: 65, label: 'Thrust' },
        '22e83195': { emoji: '\uD83D\uDEA8', driverVar: 'fine', min: 0, max: 50, label: 'Fine' },
        'cfc35e91': { emoji: '\uD83C\uDF0A', driverVar: 'erosion', min: 0, max: 34, label: 'Erosion' },
        'c97852e8': { emoji: '\uD83C\uDF1F', driverVar: 'fame', min: 0, max: 24, label: 'Fame' },
        '29ca09e5': { emoji: '\uD83C\uDFA8', driverVar: 'paint', min: 32, max: 32, label: 'Paint' },
        'b45f39ef': { emoji: '\u2B50', driverVar: 'rating', min: 0, max: 15, label: 'Rating' },
        'a697986e': { emoji: '\uD83D\uDCB3', driverVar: 'months', min: 0, max: 6, label: 'Months' },
        '8e7c84e3': { emoji: '\uD83C\uDFF0', driverVar: 'rounds', min: 0, max: 5, label: 'Rounds' },
        '0edcd127': { emoji: '\uD83C\uDFE6', driverVar: 'months', min: 0, max: 5, label: 'Months' },
        'dab9790e': { emoji: '\uD83C\uDCCF', driverVar: 'deck', min: 52, max: 52, label: 'Deck' },
        '3dd6d36b': { emoji: '\uD83D\uDD6F\uFE0F', driverVar: 'candles', min: 0, max: 3, label: 'Candles' },
        '4a8682cf': { emoji: '\uD83E\uDE82', driverVar: 'ticks', min: 0, max: 4, label: 'Ticks' },
        'c8db3bd8': { emoji: '\uD83C\uDFAC', driverVar: 'render', min: 0, max: 50, label: 'Render' },
        '4502e60f': { emoji: '\uD83D\uDD2B', driverVar: 'shots', min: 0, max: 5, label: 'Shots' },
        '0a55ab21': { emoji: '\uD83C\uDFC6', driverVar: 'games', min: 25, max: 25, label: 'Games' },
        '3d465883': { emoji: '\uD83D\uDCAF', driverVar: 'final', min: 80, max: 80, label: 'Final' },
        '41dd90ac': { emoji: '\uD83D\uDC8D', driverVar: 'rings', min: 9, max: 9, label: 'Rings' },
        '4c1b8ed0': { emoji: '\uD83C\uDFDE\uFE0F', driverVar: 'miles', min: 0, max: 5, label: 'Miles' },
        '731f2ee8': { emoji: '\uD83D\uDCF1', driverVar: 'views', min: 0, max: 40, label: 'Views' },
        'c16b1ad3': { emoji: '\u269B\uFE0F', driverVar: 'molecule', min: 0, max: 39, label: 'Molecule' },
        '49d205e8': { emoji: '\uD83C\uDFD4\uFE0F', driverVar: 'altitude', min: 100, max: 160, label: 'Altitude' },
        'b435c0fd': { emoji: '\uD83D\uDCCA', driverVar: 'cells', min: 48, max: 48, label: 'Cells' },
        'e5040324': { emoji: '\u2622\uFE0F', driverVar: 'energy', min: 0, max: 60, label: 'Energy' },
        'e8f97928': { emoji: '\uD83D\uDCE1', driverVar: 'size', min: 32, max: 32, label: 'Size' },
        '7fb4c8ac': { emoji: '\u2694\uFE0F', driverVar: 'blade', min: 0, max: 40, label: 'Blade' },
        '0708a5aa': { emoji: '\uD83D\uDD0A', driverVar: 'ticks', min: 0, max: 6, label: 'Ticks' },
        'b934e6e3': { emoji: '\uD83D\uDD24', driverVar: 'letters', min: 26, max: 26, label: 'Letters' },
        'd94317d9': { emoji: '\uD83E\uDE99', driverVar: 'vault', min: 0, max: 30, label: 'Vault' },
        '6a3807ce': { emoji: '\uD83D\uDC7E', driverVar: 'turns', min: 0, max: 2, label: 'Turns' },
        'd32a01ee': { emoji: '\uD83D\uDE97', driverVar: 'distance', min: 0, max: 55, label: 'Distance' },
        'e81f8ca3': { emoji: '\uD83C\uDFED', driverVar: 'output', min: 0, max: 42, label: 'Output' },
        '9029621b': { emoji: '\uD83E\uDD5A', driverVar: 'supply', min: 84, max: 84, label: 'Supply' },
        '2cbfd572': { emoji: '\uD83D\uDC4D', driverVar: 'followers', min: 0, max: 52, label: 'Followers' },
        'e7c5d852': { emoji: '\uD83E\uDD50', driverVar: 'pastries', min: 0, max: 9, label: 'Pastries' },
        '9996e2fb': { emoji: '\uD83C\uDFA4', driverVar: 'fans', min: 100, max: 145, label: 'Fans' },
        'd7d5b7f2': { emoji: '\uD83E\uDDF5', driverVar: 'patches', min: 0, max: 45, label: 'Patches' },
        'c5a30bc0': { emoji: '\u26F5', driverVar: 'sail', min: 0, max: 50, label: 'Sail' },
        '66b486bd': { emoji: '\uD83D\uDCDD', driverVar: 'poem', min: 17, max: 17, label: 'Poem' },
        'b53719d7': { emoji: '\uD83D\uDC2C', driverVar: 'pod', min: 17, max: 17, label: 'Pod' },
        'b202a774': { emoji: '\uD83E\uDE99', driverVar: 'chests', min: 0, max: 44, label: 'Chests' },
        '15fd3b3c': { emoji: '\uD83E\uDDD7', driverVar: 'climbed', min: 0, max: 26, label: 'Climbed' },
        '22ba8601': { emoji: '\u2694\uFE0F', driverVar: 'blade', min: 40, max: 40, label: 'Blade' },
        '7c531481': { emoji: '\u2B50', driverVar: 'celestial', min: 33, max: 33, label: 'Celestial' },
        'b2de602e': { emoji: '\uD83C\uDFF0', driverVar: 'fort', min: 0, max: 40, label: 'Fort' },
        '32b04673': { emoji: '\uD83C\uDF31', driverVar: 'plantings', min: 0, max: 5, label: 'Plantings' },
        '96cb8b64': { emoji: '\u2622\uFE0F', driverVar: 'fission', min: 4, max: 32, label: 'Fission' },
        '8472b8ce': { emoji: '\uD83C\uDF89', driverVar: 'bonus', min: 0, max: 90, label: 'Bonus' },
        '3fab8c66': { emoji: '\uD83D\uDCE6', driverVar: 'boxes', min: 0, max: 6, label: 'Boxes' },
        'b5fbe53a': { emoji: '\uD83C\uDFC0', driverVar: 'points', min: 0, max: 20, label: 'Points' },
        '1039e2e6': { emoji: '\uD83C\uDFC5', driverVar: 'medals', min: 40, max: 40, label: 'Medals' },
        '6be5493e': { emoji: '\uD83C\uDF21\uFE0F', driverVar: 'status', min: 0, max: 25, label: 'Status' },
        'd8568885': { emoji: '\uD83D\uDCB8', driverVar: 'months', min: 0, max: 5, label: 'Months' },
        'c8ec5185': { emoji: '\uD83D\uDCF7', driverVar: 'memories', min: 42, max: 42, label: 'Memories' },
        'd23f583b': { emoji: '\uD83D\uDD10', driverVar: 'a', min: 7, max: 11, label: 'A' },
        '4bff18d0': { emoji: '\uD83C\uDF27\uFE0F', driverVar: 'erosion', min: 0, max: 35, label: 'Erosion' },
        '87e4cf86': { emoji: '\uD83C\uDF40', driverVar: 'prize', min: 0, max: 21, label: 'Prize' },
        '85d0ca14': { emoji: '\uD83D\uDDA8\uFE0F', driverVar: 'print', min: 0, max: 36, label: 'Print' },
        'f989651c': { emoji: '\uD83D\uDC1D', driverVar: 'swarm', min: 150, max: 150, label: 'Swarm' },
        '54fa7820': { emoji: '\uD83E\uDDDD', driverVar: 'fellowship', min: 15, max: 15, label: 'Fellowship' },
        '3349f0e4': { emoji: '\u2615', driverVar: 'dishes', min: 15, max: 15, label: 'Dishes' },
        'fce33bc2': { emoji: '\uD83D\uDDE3\uFE0F', driverVar: 'rumor', min: 3, max: 81, label: 'Rumor' },
        'fcf90756': { emoji: '\uD83E\uDE9A', driverVar: 'builds', min: 0, max: 6, label: 'Builds' },
        '5cc2afb5': { emoji: '\uD83C\uDFC8', driverVar: 'athletes', min: 44, max: 44, label: 'Athletes' },
        '2ee7fea0': { emoji: '\uD83C\uDFB9', driverVar: 'sessions', min: 0, max: 5, label: 'Sessions' },
        '14bf64e5': { emoji: '\uD83D\uDC1D', driverVar: 'harvest', min: 0, max: 50, label: 'Harvest' },
        'f84c7e51': { emoji: '\uD83D\uDCDA', driverVar: 'library', min: 75, max: 75, label: 'Library' },
        '47225682': { emoji: '\u2699\uFE0F', driverVar: 'alloy', min: 14, max: 14, label: 'Alloy' },
        '184eb292': { emoji: '\u2B06\uFE0F', driverVar: 'tier', min: 0, max: 150, label: 'Tier' },
        'd23e7b74': { emoji: '\uD83D\uDCC8', driverVar: 'trade', min: 0, max: 70, label: 'Trade' },
        'e86a28c7': { emoji: '\uD83D\uDCBB', driverVar: 'quality', min: 0, max: 50, label: 'Quality' },
        '6fecb3b6': { emoji: '\uD83C\uDF39', driverVar: 'bouquet', min: 25, max: 25, label: 'Bouquet' },
        'c9e041b1': { emoji: '\u23F1\uFE0F', driverVar: 'time', min: 30, max: 30, label: 'Time' },
        '07eb2c7f': { emoji: '\uD83D\uDCA8', driverVar: 'releases', min: 0, max: 100, label: 'Releases' }
    };
