...
## Files
- `index.html`, `style.css`, `game.js` (core engine), `engine.module.js` (testable pure logic — keep in sync with game.js), `puzzles.js` (inline data + daily selection), `puzzles.json` (for validator), `share.js`, `generate.py`, `validate.py`, `debug.html` (gitignored)
